      ...
      <section className="relative py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            >
              Insights on ICT trends and best practices
            </motion.p>
          </motion.div>
          ...
          >
            <p className="text-gray-400 text-lg mb-6">
              Our blog is coming soon! We&apos;ll be sharing insights on ICT trends, cybersecurity best practices, 
              network optimization tips, and industry updates.
            </p>
            <Link
              href="/"
